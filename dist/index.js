...
let Help = /*#__PURE__*/function () {
  ...
  _createClass(Help, [{
     ...
     * @returns {number}
     */
    function longestOptionTermLength(cmd, helper) {
     ...
     * @returns {number}
     */
    function longestArgumentTermLength(cmd, helper) {
...
let Option = /*#__PURE__*/function () {
  ...
  _createClass(Option, [{
     ...
     * @return {Option}
     */
    function makeOptionMandatory(mandatory = true) {
     ...
     * @api private
     */
    function _concatValue(value, previous) {
...
let CommanderError = /*#__PURE__*/function (_Error) {
...
let InvalidOptionArgumentError = /*#__PURE__*/function (_CommanderError) {
  _inherits(InvalidOptionArgumentError, _CommanderError);

  var _super2 = _createSuper(InvalidOptionArgumentError);
   ...
   * @constructor
   */
  function InvalidOptionArgumentError(message) {
    var _this2;

    _classCallCheck(this, InvalidOptionArgumentError);

    _this2 = _super2.call(this, 1, 'commander.invalidOptionArgument', message); // properly capture stack trace in Node.js
...
let Command = /*#__PURE__*/function (_EventEmitter) {
  _inherits(Command, _EventEmitter);

  var _super3 = _createSuper(Command);
  ...
  function Command(name) {
    ...
    _this3.options = [];
    _this3.parent = null;
    _this3._allowUnknownOption = false;
    _this3._allowExcessArguments = true;
    _this3._args = [];
    _this3.rawArgs = null;
    _this3._scriptPath = null;
    _this3._name = name || '';
    _this3._optionValues = {};
    _this3._storeOptionsAsProperties = false;
    _this3._actionResults = [];
    _this3._actionHandler = null;
    _this3._executableHandler = false;
    _this3._executableFile = null; // custom name for executable

    _this3._defaultCommandName = null;
    _this3._exitCallback = null;
    _this3._aliases = [];
    _this3._combineFlagAndOptionalValue = true;
    _this3._description = '';
    _this3._argsDescription = undefined;
    _this3._enablePositionalOptions = false;
    _this3._passThroughOptions = false; // see .configureOutput() for docs

    _this3._outputConfiguration = {
    ...
    _this3._hidden = false;
    _this3._hasHelpOption = true;
    _this3._helpFlags = '-h, --help';
    _this3._helpDescription = 'display help for command';
    _this3._helpShortFlag = '-h';
    _this3._helpLongFlag = '--help';
    _this3._addImplicitHelpCommand = undefined; // Deliberately undefined, not decided whether true or false

    _this3._helpCommandName = 'help';
    _this3._helpCommandnameAndArgs = 'help [command]';
    _this3._helpCommandDescription = 'display help for command';
    _this3._helpConfiguration = {};
    return _this3;
  }
  /**
   * Define a command.
  ...
  _createClass(Command, [{
     ...
     */
    function configureHelp(configuration) {
     ...
     * @return {Command} `this` command for chaining
     */
    function addHelpCommand(enableOrNameAndArgs, description) {
     ...
     * @api private
     */
    function _hasImplicitHelpCommand() {
     ...
     * @api private
     */
    function _parseExpectedArgs(args) {
     ...
     * @api private
     */
    function _exit(exitCode, code, message) {
    ...
    * @return {Command} `this` command for chaining
    */
    function requiredOption(flags, description, fn, defaultValue) {
     ...
     */
    function combineFlagAndOptionalValue(combine = true) {
     ...
     * for unknown options.
     */
    function allowUnknownOption(allowUnknown = true) {
     ...
     */
    function allowExcessArguments(allowExcess = true) {
     ...
     */
    function enablePositionalOptions(positional = true) {
     ...
     * for unknown options.
     */
    function passThroughOptions(passThrough = true) {
    ...
    /**
      ...
      * @return {Command} `this` command for chaining
      */
    function storeOptionsAsProperties(storeAsProperties = true) {
     ...
     * @api private
     */
    function _setOptionValue(key, value) {
      if (this._storeOptionsAsProperties) {
        this[key] = value;
      } else {
     ...
     * @return {Command} `this` command for chaining
     */
    function parse(argv, parseOptions) {
     ...
     * @api private
     */
    function _executeSubCommand(subcommand, args) {
      args = args.slice();
 ...
 - if the default executable name is not suitable, use the executableFile option to supply a custom name`;
     ...
     * @api private
     */
    function _dispatchSubcommand(commandName, operands, unknown) {
     ...
     * @api private
     */
    function _parseCommand(operands, unknown) {
     ...
     * @api private
     */
    function _checkForMissingMandatoryOptions() {
     ...
     * @api private
     */
    function _displayError(exitCode, code, message) {
     ...
     * @api private
     */
    function optionMissingArgument(option) {
     ...
     * @api private
     */
    function missingMandatoryOptionValue(option) {
     ...
     * @api private
     */
    function _excessArguments(receivedArgs) {
     ...
     */
    function version(str, flags, description) {
     ...
     */
    function description(str, argsDescription) {
     ...
     * @return {string[]|Command}
     */
    function aliases(_aliases) {
      // Getter for the array of aliases is the main reason for having aliases() in addition to alias().
      if (_aliases === undefined) return this._aliases;

      _aliases.forEach(alias => this.alias(alias));
     ...
     * @return {string}
     */
    function helpInformation(contextOptions) {
     ...
     * @api private
     */
    function _getHelpContext(contextOptions) {
     ...
     * @return {Command} `this` command for chaining
     */
    function helpOption(flags, description) {
     ...
     * @return {Command} `this` command for chaining
     */
    function addHelpText(position, text) {
